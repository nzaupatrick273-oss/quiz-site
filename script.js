// ============================================
// COMPLETE QUESTION BANK (4000+ Questions)
// ============================================

const QUESTION_BANK = {
    // =========================================
    // 1. BIBLE (400+ Questions)
    // =========================================
    bible: {
        easy: [
        ...
        medium: [
            ...
            { q: "Who was the king that saw the handwriting on the wall?", a: ["Nebuchadnezzar", "Belshazzar", "Darius", "Cyrus"], correct: 1 },
            { q: "What did the Israelites eat in the wilderness?", a: ["Bread", "Manna", "Quail", "All of the above"], correct: 3 },
    ...
    // =========================================
    // 2. GENERAL KNOWLEDGE (400+ Questions)
    // =========================================
    general: {
        easy: [
    ...
    physics: {
        ...
        medium: [
            ...
            { q: "What is the formula for power?", a: ["W/t", "F×d", "m×a", "W×t"], correct: 0 },
            { q: "What is the SI unit of voltage?", a: ["Ampere", "Volt", "Ohm", "Watt"], correct: 1 },
            { q: "What is the SI unit of resistance?", a: ["Ampere", "Volt", "Ohm", "Watt"], correct: 2 }
        ],
        hard: [
            ...
            { q: "What is the formula for the Bohr radius?", a: ["n²h²/(4π²mke²)", "nh²/(4π²mke²)", "n²h/(4π²mke²)", "n²h²/(4π²ke²)"], correct: 0 }
        ]
    },

    // =========================================
    // 8. SURVEY (400+ Questions)
    // =========================================
    survey: {
        easy: [
            ...
            { q: "What type of question yields quantitative data?", a: ["Open-ended", "Closed-ended", "Likert scale", "Multiple choice"], correct: 1 },
            { q: "What is a demographic question?", a: ["Age", "Income", "Education", "All of the above"], correct: 3 },
            { q: "What is the most common survey distribution method?", a: ["Email", "Mail", "Online", "Phone"], correct: 2 }
        ],
        medium: [
            ...
            { q: "What is the difference between primary and secondary data?", a: ["Original vs. existing", "Quantitative vs. qualitative", "New vs. old", "First-hand vs. second-hand"], correct: 3 }
        ],
        hard: [
            ...
            { q: "What is a matched pairs design?", a: ["Before-after study", "Cross-sectional study", "Longitudinal study", "Case-control study"], correct: 0 }
        ]
    },

    // =========================================
    // 9. ONLINE (400+ Questions)
    // =========================================
    online: {
        easy: [
            ...
            { q: "What is a blog?", a: ["Website", "Online journal", "Social media", "Forum"], correct: 1 },
            { q: "What is social media?", a: ["Online platforms", "Communication tools", "Content sharing", "All of the above"], correct: 3 },
            { q: "What is the most popular social media platform?", a: ["Facebook", "Instagram", "YouTube", "Twitter"], correct: 0 },
            { q: "What is an IP address?", a: ["Internet Protocol address", "Internal Protocol address", "International Protocol address", "Integrated Protocol address"], correct: 0 }
        ],
        medium: [
            ...
            { q: "What is the most common programming language?", a: ["Python", "JavaScript", "Java", "C++"], correct: 1 }
        ],
        hard: [
            ...
            { q: "What is the difference between symmetric and asymmetric encryption?", a: ["Same key vs. different keys", "Same algorithm vs. different", "Fast vs. slow", "Secure vs. insecure"], correct: 0 }
        ]
    },

    // =========================================
    // 10. ETIQUETTE (400+ Questions)
    // =========================================
    etiquette: {
        easy: [
            ...
            { q: "What is the proper way to address an elder?", a: ["First name", "Title and last name", "Nickname", "Ma'am/Sir"], correct: 1 },
            { q: "What should you do before a meal?", a: ["Wash hands", "Say grace", "Wait for host", "All of the above"], correct: 3 },
            { q: "What is the proper way to shake hands?", a: ["Firm grip", "Eye contact", "Brief shake", "All of the above"], correct: 3 },
            { q: "What should you do when someone is speaking?", a: ["Listen", "Interrupt", "Look away", "Multitask"], correct: 0 },
            { q: "What is appropriate dress code for a wedding?", a: ["Formal", "Casual", "Business", "Beachwear"], correct: 0 }
        ],
        medium: [
            ...
            { q: "What should you do after a meal?", a: ["Thank host", "Offer to help", "Push in chair", "All of the above"], correct: 3 },
            { q: "What is the proper way to answer a phone?", a: ["Hello", "Yes", "Speak", "Greeting and name"], correct: 3 }
        ],
        hard: [
            ...
            { q: "What is the golden rule of etiquette?", a: ["Treat others as you want to be treated", "Be first", "Be loud", "Be late"], correct: 0 }
        ]
    },

    // =========================================
    // 11. TALENTS (400+ Questions)
    // =========================================
    talents: {
        easy: [
            ...
            { q: "What is the most sought-after talent?", a: ["Leadership", "Creativity", "Problem-solving", "Communication"], correct: 0 },
            { q: "What is the key to developing talent?", a: ["Practice", "Natural ability", "Education", "All of the above"], correct: 3 },
            { q: "What is the best way to showcase talent?", a: ["Auditions", "Portfolio", "Performances", "All of the above"], correct: 3 },
            { q: "What is the most common musical instrument learned?", a: ["Guitar", "Piano", "Violin", "Drums"], correct: 0 },
            { q: "What is the most popular form of art?", a: ["Painting", "Music", "Dance", "Acting"], correct: 1 }
        ],
        medium: [
            ...
            { q: "What is the role of genetics in talent?", a: ["Significant", "Minor", "No role", "Not known"], correct: 0 },
            { q: "What is the best way to find your talent?", a: ["Explore", "Test", "Advice", "All of the above"], correct: 3 }
        ],
        hard: [
            ...
            { q: "What is the most important factor in talent recognition?", a: ["Performance", "Potential", "Consistency", "All of the above"], correct: 3 },
            { q: "What is the role of education in talent development?", a: ["Enhances talent", "Suppresses talent", "No effect", "Replaces talent"], correct: 0 }
        ]
    },

    // =========================================
    // 12. GEOGRAPHY (400+ Questions)
    // =========================================
    geography: {
        easy: [
            ...
            { q: "What is the smallest country?", a: ["Monaco", "Vatican City", "San Marino", "Liechtenstein"], correct: 1 }
        ],
        medium: [
...
// ============================================
// EXPANDED CATEGORIES (Adding more)
// ============================================

// Adding Technology questions
...
function endQuiz() {
    ...
    if (accuracy >= 90) {
        ...
        message = state.category === 'bible' 
            ? 'Amazing! You truly know the Word! 🙏'
            : state.category === 'physics'
            ? 'Brilliant! You\'re a Physics genius! 🧪'
            : 'Outstanding! You\'re an absolute expert! 🌟';
    } else if (accuracy >= 70) {
        title = `🌟 Great Job!`;
...
document.addEventListener('keydown', (e) => {
    if (e.key >= '1' && e.key <= '4' && state.gameActive && !state.isPaused) {
        const btns = DOM.answers.querySelectorAll('.answer-btn');
        const index = parseInt(e.key) - 1;
        if (btns[index] && !btns[index].classList.contains('disabled')) {
            selectAnswer(btns[index]);
        }
    }
